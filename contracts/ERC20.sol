...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function approve( address owner_, address spender_, uint256 amount_ ) public virtual override returns( bool ){
    ...
    function increaseAllowance( address spender, uint256 amount_ ) public returns( bool ){
        address owner = _msgSender();
        _approve( owner, spender, allowance( owner, spender ) + amount_ );
